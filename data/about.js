  ...
  missionVisionSection: {
    mission: {
      ...
      description: (
        <>
          <li>
            We aim to EMBED a culture of doing our business ethically and with
            integrity.
          </li>
          <li>
            We EXCEED customer expectations through innovative premium products
            and services.
          </li>
          <li>
            We ENCOURAGE and FINANCE meaningful social and economic activities
            for our community.
          </li>
        </>
      ),
