...
export const BLOGS = [
  ...
  },
  {
    ...
    title: "Planning Kitchen Cabinets: Types and Functions Overview",
    subtitle:
  ...
  },
  {
    ...
    title: "Classical Kitchen Design - Reinterpreted",
    ...
    content: (
      <>
        <div className="editorial-group">
          <h2 className="text-4xl font-bold">Style-defining elements</h2>
          <div className="space-y-2">
            <p>
              New Classic also includes details that underline the independent
              character of these kitchens without creating a rustic feel:
            </p>
            <ul style={{ listStyle: "disc", paddingLeft: "1.25em" }}>
              <li>
                Handleless glass doors for bottom, wall and side cabinets
                feature an impressive frame design with an attractive double
                structure.
              </li>
              <li>
                Bronze-tinted glass, harmonising perfectly with the frame,
                reinforces this elegance.
              </li>
              <li>
                The more conventional handles are also based on a clear
                stylistic idiom - sometimes they are oval with matching subtly
                playful lines, sometimes their lines are completely straight.
              </li>
              <li>
                Graphic cornices, simple light strips and pilasters with subtle
                fluting for an elegant end piece on the side are perfect for a
                purist design.
              </li>
              <li>
                Protruding base elements, which make the cabinets look like
                free-standing furniture, also contribute to the distinctive
                look.
              </li>
            </ul>
            <p>
              <span>
                Which fronts and other components from the Nolte K&uuml;chen
                product range are ideal for designing a New Classic style? We
                have put together some tips and ideas:
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          ...
          <div className="flex-1">
            ...
            <p className="text-justify">
              ...
              design with an offset frame make it a real eye-catcher. As part of
              the Nolte Küchen mat lacquer concept, it is available in 19
              colours.
            </p>
          </div>
        </div>
  ...
  },
  {
    ...
    <>
      ...
      image: "https://kanto.ph/wp-content/uploads/2025/02/Nolte-Kuchen-Philippines-Josh-Patrick-Cua-Kassi-Distributors-Kanto.PH-Creative-Corners-36-scaled.jpg"
  }
];
